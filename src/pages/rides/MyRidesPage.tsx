...
import { getMyRides } from "../../api/rides/rides";
...
export default function MyRidesPage() {
  ...
  if (user?.role === "DRIVER") {
    return (
      <Alert severity="info">
        Driver accounts should use Driver My Rides and Available Rides pages.
      </Alert>
    );
  }
      ...
      >
        <Stack spacing={1}>
          ...
          <Typography color="text.secondary">
            Review previously requested rides and open the full details of any
            trip.
          </Typography>
        </Stack>
        ...
        >
          <CardContent sx={{ p: { xs: 3, md: 4 } }}>
            <Stack spacing={1.75} alignItems="flex-start">
              ...
              <Typography color="text.secondary">
                Create your first ride request to see it listed here.
              </Typography>
